...
function DateRange() {
  ...
  Uses Instruction
        ...
        <div className="py-4 px-6 border-b border-gray-200">
           <p className="text-sm text-[#4b5675]">Quill is delivered primarily via npm. <span className="ms-1 text-[#e83e8c] py-[3px] px-2 rounded bg-[#f1f2f3] text-sm w-max">
            npm install react-icons --save
          </span></p>
        </div>
        <div className="py-4 px-6">
           <p className="text-sm text-[#4b5675]">For full documentation please visit the link: <strong>https://hypeserver.github.io/react-date-range/</strong></p>
        </div>
      </div>

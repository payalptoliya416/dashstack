...
import { FontAwesomeIconData, FontAwesomeIcons, type IconItem } from "./FontAwesomeIconData";
...
function FontAwesomeIcon() {
  ...
  const filteredIcons = FontAwesomeIcons.filter((icon: IconItem) =>

              ...
              <div className="col-span-12 xl:col-span-4">
                <div className="shadow-sm rounded-lg p-6 bg-white mb-6">
                    <div className="flex  justify-between mb-10">
                        <h3 className="text-[17px] leading-[20px] font-bold text-darkgray/90">Compleation</h3>
                        <h3 className="group text-blue text-sm cursor-pointer">  Complete   <ArrowRight
                        className="inline-block text-blue ms-1 transition-transform duration-200 group-hover:translate-x-1"
                        size={12}   /></h3>
                    </div>
                    <UseProgressBar
                ...
                <div className="shadow-sm rounded-lg p-6 bg-white mb-6">
                     <h3 className="text-[17px] leading-[20px] font-bold text-darkgray/90 mb-6">Introduction</h3>
                     {/* -- */}
                     <ul className="mb-7">
                        {introData.map((item, idx) => (
                        <li key={idx} className="flex gap-4 mb-3">
                            <h3 className="text-lightgray text-sm w-36 font-bold">{item.label}</h3>
                            <p className="text-sm text-lightgray">{item.value}</p>
                        </li>
                        ))}
                     </ul>
                      {/* -- */}
                 ...
                 <div className="shadow-sm rounded-lg p-6 bg-white mb-6">
                      <div className="flex  justify-between mb-10">
                        <h3 className="text-[17px] leading-[20px] font-bold text-darkgray/90">Compleation</h3>
                         <Plus className="inline-block text-darkgray ms-1" size={18}/>
                    </div>
                ...
                <div className="shadow-sm rounded-lg p-6 bg-white xl:mb-6">
                     <h3 className="text-[17px] leading-[20px] font-bold text-darkgray/90 mb-6">Connections</h3>
                     {connections.map((conn, idx) => (
                        ...
                        <div className="flex gap-3 items-center">
                            ...
                            <div>
                            <h3 className="text-sm text-darkgray/80 font-semibold">{conn.name}</h3>
                            <p className="text-[12px] text-graytext">{conn.connections} Connections</p>
                            </div>
                        </div>
                         <button
                      ...
                      <h3 className="group text-blue text-sm cursor-pointer">  All Connections   <ArrowRight
                        className="inline-block text-blue ms-1 transition-transform duration-200 group-hover:translate-x-1" size={12}   /></h3>
                </div>
              </div>
              <div className="col-span-12 xl:col-span-8">
                   <div className="shadow-sm rounded-lg p-6 bg-white mb-6">
                     <h3 className="text-[17px] leading-[20px] font-bold text-darkgray/90 mb-6">About Me</h3>
                     ...
                     <ul className="mb-4 list-disc ps-6">
                        <li className="text-sm text-lightgray">Dreams 👉 Goals</li>
                        <li className="text-sm text-lightgray">Midnight snacker 🌝</li>
                        <li className="text-sm text-lightgray">Recovering cake addict 🎂</li>
                        <li className="text-sm text-lightgray">I make money in my sleep 🛌</li>
                        <li className="text-sm text-lightgray">People call me Sara, but you can call me tonight 😉</li>
                     </ul>
                     <p className="text-sm text-lightgray mb-1">Looking forward to hearing from you!</p>
                     <p className="text-sm text-lightgray">Thanks by, <strong>Alexandra Della</strong></p>
                   </div>
                   <div className="shadow-sm rounded-lg p-6 bg-white mb-6">
                     <h3 className="text-[17px] leading-[20px] font-bold text-darkgray/90 mb-6">Experiences</h3>
                      {experiences.map((exp, idx) => (
                        ...
                        <div>
                            ...
                            <p className="text-[12px] text-lightgray mb-1">
                            <span>{exp.date}</span> <span className="mx-1">•</span> <span>{exp.duration}</span>
                            </p>
                            <p className="text-sm text-lightgray mb-4">{exp.description}</p>
                            <h3 className="group hover:text-blue text-sm cursor-pointer font-bold">
                            View Details
                            <MoveRight className="inline-block hover:text-blue ms-1 transition-transform duration-200 group-hover:translate-x-1" size={14} />
                            </h3>
                        </div>
                        </div>
                    ))}
                   ...
                   <div className="shadow-sm rounded-lg p-6 bg-white mb-6">
                     <h3 className="text-[17px] leading-[20px] font-bold text-darkgray/90 mb-6">Interested</h3>
                     {interests.map((cat, idx) => (
                        <div key={idx} className="border-b border-gray-100 py-4 flex gap-2 flex-wrap">
                        <h3 className="text-graytext text-sm me-4">{cat.title}</h3>

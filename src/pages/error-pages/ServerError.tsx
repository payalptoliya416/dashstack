...
function ServerError() {
  return (
   <div className="min-h-screen w-full bg-[url('/images/loginbg.png')] bg-cover bg-center flex items-center justify-center overflow-y-auto px-4 py-10">
                 ...
                 <h1 className="text-8xl font-bold mb-5 text-blue-light">500</h1>
                 <h3 className="text-darkgray font-semibold text-lg sm:text-2xl md:text-[32px] mb-7 md:mb-[35px]">Internal server error!</h3>

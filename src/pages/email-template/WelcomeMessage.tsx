       ...
       <div className="bg-white rounded-xl w-full max-w-[650px] shadow-lg">
        ...
        <div className="p-7 sm:p-10">
          <div className="text-center">
            <img src="/images/roket.svg" alt="" className="my-6 pb-12 mx-auto" />
            <h3 className="text-xl sm:text-2xl mb-4 font-bold text-darkgray">
              Welcome, Alexandra Della
            </h3>
            <p>
              Lots of people make mistakes while creating paragraphs. Some
              writers just put whitespace in their text in random places.
            </p>
         ...
         <Link to='/eCommerce' className="block group text-blue text-base cursor-pointer my-11 text-center font-bold">  <ArrowLeft className="inline-block text-blue me-1 transition-transform duration-200 group-hover:-translate-x-1" size={12}/> Back to Home </Link>
     </div>
    </div>
              </motion.div>
  );

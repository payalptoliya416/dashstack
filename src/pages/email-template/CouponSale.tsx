        ...
        <div className="bg-white rounded-xl w-full max-w-[650px] shadow-lg">
          ...
          <div className="p-7 sm:p-10">
            <div className="text-center">
             ...
             <h3 className='text-3xl sm:text-5xl sm:text-[80px] sm:leading-[86px] font-black'><span className='text-white mr-4'>25%</span><span className='text-lightgray'>OFF</span></h3>
             <button className='mt-12 px-3 sm:px-5 py-[10px] rounded text-white text-sm bg-blue-text'>Claim your coupon 

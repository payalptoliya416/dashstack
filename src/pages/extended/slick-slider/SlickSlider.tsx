    ...
    <>
      ...
      <div className="rounded-lg shadow border border-gray-100 bg-white col-span-12 2xl:col-span-6 mb-7">
        ...
        <div className="py-4 px-6 border-b border-gray-200">
          <p className=" text-sm text-[#4B5675]">Slick is delivered primarily via npm. 
        ...
        npm install react-slick --save
          ...
          <div className="py-4 px-6">
             <p className=" text-sm text-[#4B5675]">For full documentation please visit the link: <a href="https://react-slick.neostack.com/docs/get-started" className=" break-all"><strong className="underline">https://react-slick.neostack.com/docs/get-started</strong></a></p>
          </div>
      </div>
    </>
  )

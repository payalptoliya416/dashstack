  ...
  return (
    <>
      ...
      <div
        {...getRootProps({
          className:
            "border border-gray-300 rounded border-dotted p-4 sm:p-6 min-h-[300px] flex justify-center items-center flex-col mb-7 cursor-pointer text-center",
        })}
      >
        <input {...getInputProps()} />

  ...
  return (
    <>
      ...
      <div className="rounded-lg shadow-md border border-gray-200 bg-white mt-7">
        ...
        <div className="py-4 px-6 border-b border-gray-200">
          <p className=" text-sm text-[#4B5675]">Dropzone is delivered primarily via npm.
    ...
    npm install --save react-dropzone
          ...
          <div className="py-4 px-6">
             <p className=" text-sm text-[#4B5675]">For full documentation please visit the link: <a href="https://react-dropzone.js.org/" className=" break-all"><strong className="underline">https://react-dropzone.js.org/</strong></a></p>
          </div>
      </div>     
    </>
  )

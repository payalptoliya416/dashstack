...
function Checkboxs() {
  ...
  const [selected7, setSelected7] = useState<string[]>([]);
  const [selected8, setSelected8] = useState<string[]>([]);
    ...
    <>
      ...
      <div className="rounded-lg shadow border border-gray-100 bg-white mb-7">
        ...
        <div className="p-4 md:p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-7">
            {plans.map((plan) => {
              const isActive = selected1.includes(plan.id);
              return (
                <div
                  key={plan.id}
                  onClick={() =>
        ...
        <div className="p-4 md:p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5 sm:gap-7">
            {shippingOptions.map((option) => {
              const isActive = selected2.includes(option.id);
              return (
                <div
                  key={option.id}
                  onClick={() =>
        ...
        <div className="p-4 md:p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-7">
            {paymentOptions.map((option) => {
              const isActive = selected3.includes(option.id);
              return (
                <div
                  key={option.id}
                  onClick={() =>
                    toggleSelection(option.id, selected3, setSelected3)
                  }
        ...
        <div className="p-4 md:p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-7">
            {businessPlans.map((plan) => {
              const isActive = selected4.includes(plan.id);
              return (
                <div
                  key={plan.id}
                  onClick={() =>
                    toggleSelection(plan.id, selected4, setSelected4)
                  }
      ...
      <div className="rounded-lg shadow border border-gray-100 bg-white mb-7">
        ...
        <div className="p-4 md:p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5 sm:gap-7">
            {iconPlans.map((plan) => {
              const isActive = selected5.includes(plan.id);
        ...
        <div className="p-4 md:p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-7">
            {contactCards.map((card) => {
              const isActive = selected6.includes(card.id);
              return (
                <div
                  key={card.id}
                  onClick={() =>
      ...
      <div className="rounded-lg shadow border border-gray-100 bg-white mb-7">
        ...
        <div className="p-4 md:p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-7">
            {cardPlans.map((plan) => {
              const isActive = selected7.includes(plan.id);
              return (
                <div
                  key={plan.id}
                  onClick={() =>
                    toggleSelection(plan.id, selected7, setSelected7)
                  }
                ...
                >
                  ...
                  <div className="p-4 sm:p-6">
                    ...
                    <p className="text-[#6C757D] text-sm mb-4 font-semibold">
                      {plan.description}
                    </p>
        ...
        <div className="p-4 md:p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5 sm:gap-7">
            {imageOptions.map((image) => {
              const isActive = selected8.includes(image.id);
              return (
                <div
                  key={image.id}
                  onClick={() =>

...
export const radiosTable: Option[] = [
  ...
  },
  {
    ...
    Use
        <button className="text-[#e83e8c] py-[2px] mx-1 px-1 rounded bg-[#f1f2f3] text-sm">
        .check-icon
        </button>class for custom radio check.
      </>
    ),
  },
  {
    reference: ".radio-card-wrapper",
    details: (
      <>
   Use 
        <button className="text-[#e83e8c] py-[2px] mx-1 px-1 rounded bg-[#f1f2f3] text-sm">
       .radio-card-wrapper
        </button> class for wrapping radio check card.
      </>
    ),
  },
  {
    reference: ".radio-card-content",
    details: (
      <>
   Use 
        <button className="text-[#e83e8c] py-[2px] mx-1 px-1 rounded bg-[#f1f2f3] text-sm">
      .radio-card-content
        </button>  class for wrapping radio check title, desc, price, etc.
      </>
    ),
  },
  {

...
const mailItemsBase = [
  { label: "Inbox", icon: <Mail size={16} /> },
  { label: "Starred", icon: <Star size={16} /> },
  { label: "Sent", icon: <Send size={16} /> },
  { label: "Draft", icon: <Pencil size={16} /> },
  { label: "Spam", icon: <TriangleAlert size={16} /> },
  { label: "Important", icon: <Star size={16} /> },
  { label: "Bin", icon: <Trash2 size={16} /> },
];
  ...
  function Inbox() {
   ...
   const mailItems: MailItem[] = mailItemsBase.map((item) => {
  let count = 0;
  ...
  switch (item.label) {
    case "Inbox":
      ...
      break;
    case "Starred":
      count = allMessages.filter((msg) => msg.important).length;
      break;
    case "Sent":
      count = 1;
      break;

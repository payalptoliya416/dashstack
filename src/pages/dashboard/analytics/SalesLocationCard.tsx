...
// Define countries
const countries: CountrySales[] = [
  { name: "United States", color: "#3B82F6", value: 9658, coordinates: [38, -97] },
  { name: "Canada", color: "#EF4444", value: 8258, coordinates: [56, -106] },
  { name: "China", color: "#22C55E", value: 7698, coordinates: [35, 104] },
  { name: "Russia", color: "#F43F5E", value: 6657, coordinates: [61, 100] },
  { name: "Brazil", color: "#000000", value: 5357, coordinates: [-10, -51] },
  { name: "Palestine", color: "#F59E0B", value: 4456, coordinates: [31.5, 35] },
];

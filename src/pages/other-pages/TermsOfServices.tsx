     ...
     <motion.div
      ...
      <div className="px-8">
        ...
        <p className="text-lightgray mb-2 text-sm">
          ...
          ThemeSwift.com cancels it. You may cancel your Subscription renewal
          either through your online account management page or by contacting
          contact@themeswift.com customer support team.
        </p>
        <p className="text-lightgray mb-2 text-sm">
          A valid payment method is required to process the payment for your
          subscription. You shall provide ThemeSwift.com with accurate and
          ...
          information, you automatically authorize ThemeSwift.com to charge all
          Subscription fees incurred through your account to any such payment
          instruments.
        </p>
        <p className="text-lightgray mb-4 text-sm">
          Should automatic billing fail to occur for any reason, ThemeSwift.com
        ...
        <p className="text-lightgray mb-2 text-sm">
          ThemeSwift.com, in its sole discretion and at any time, may modify
        ...
        <p className="text-lightgray mb-2 text-sm">
          ThemeSwift.com will provide you with a reasonable prior notice of any
        ...
        <h3 className="text-darkgray text-sm mt-12 font-bold mb-4">Refunds</h3>
        <p className="text-lightgray mb-4 text-sm">
        ...
        <ul className="list-decimal ps-5">
          <li className="text-lightgray mb-2 text-sm">
        ...
        <p className="text-lightgray mb-4 text-sm">
          ...
          property of ThemeSwift.com and its licensors. Service is protected by
          ...
          without the prior written consent of ThemeSwift.com.
        </p>
        <h3 className="text-darkgray text-sm mt-12 font-bold mb-4">
          Copyright Policy
        </h3>
        ...
        <p className="text-lightgray mb-2 text-sm">
          ...
          to contact@themeswift.com, with the subject line: “Copyright
        ...
        <div className="mt-16 text-lightgray mb-4 text-sm font-medium">
          86 out of 97 found this helpful
        </div>

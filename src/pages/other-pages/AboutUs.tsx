  ...
  return (
    ...
    <div className="px-8 py-13 sm:py-16">
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 xl:gap-5 items-center">
        <div>
          ...
          <h3 className="text-xl sm:text-4xl md:text-5xl text-darkgray font-bold mb-8 leading-[40px] sm:leading-[60px]">About our company <br/> <div className="relative inline-block border-2 border-blue px-2">
          <span className="text-blue font-bold mb-8">wrapdocers</span>
          <span className="absolute w-2 h-2 bg-blue -left-1 -top-1"></span>
          <span className="absolute w-2 h-2 bg-blue -left-1 -bottom-1"></span>
          <span className="absolute w-2 h-2 bg-blue -right-1 -top-1"></span>
          <span className="absolute w-2 h-2 bg-blue -right-1 -bottom-1"></span>
        </div> sky high.</h3>
          
          <p className="text-base md:text-xl text-lightgray mb-6">We're here to bring financial stability, improve the economy. Leave money issue with us and focus on your business & make something awesome.</p>
          <div className="flex gap-1 items-center flex-wrap">
            <button className="px-5 py-2 rounded bg-blue text-white text-sm">Pricing Plan</button>
            <button className="px-5 py-2 rounded bg-[#f1f2f3] text-darkgray text-sm">Contact Us</button>
          </div>
        </div>
    ...
    <div className="px-8">
       <div className="bg-[#F1F2F3] py-12 sm:py-24 flex justify-center items-center text-center">
        <div>
          <span className="block mb-6 text-center"><Quote className="text-blue fill-blue inline-block"/></span>
          <h4 className="text-xs text-blue uppercase mb-6">From Our Team</h4>
          <p className="text-darkgray text-base sm:text-2xl mb-6 w-full max-w-[600px] mx-auto font-semibold px-3">Untitled truely values work-life balance. We work hard and deliver, but at the end of the day you can switch off and plan better events while saving money.</p>
          <div>
            ...
            <SwiperSlide key={member.id}>
              <div className="shadow-lg rounded-lg overflow-hidden bg-white">
                ...
                <div className="p-6 text-center">
                  <h3 className="text-darkgray text-base font-bold">{member.name}</h3>
                  <p className="text-graytext text-13">{member.role}</p>
                </div>
              </div>
            </SwiperSlide>
          ))}
     ...
     <div className="px-8 border-b border-gray-100 pb-16">
      <div className="bg-[#F1F2F3] pt-16 px-8 rounded-md grid grid-cols-1 xl:grid-cols-2">
          <div>
            <h4 className="text-lightgray text-xs uppercase mb-4">Our Locations</h4>
            <h2 className="text-xl sm:text-2xl md:text-4xl text-darkgray mb-4 uppercase font-bold">Visit our office</h2>
            <p className="text-[17px] mb-4 text-lightgray">Find us at the locations.</p>
             <h3 className="group text-blue text-sm cursor-pointer mb-5 sm:mb-0">  All Available  <ArrowRight className="inline-block text-blue ms-1 transition-transform duration-200 group-hover:translate-x-1" size={12}/></h3>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 sm:gap-10 ">
            <div>
              <div className="mb-6">
                <h3 className="text-darkgray text-[17px] leading-[17px] mb-2 font-semibold">Melbourne</h3>
                <p className="text-sm text-lightgray">100 Flinders street <br/> Melbourne VIC 300, AU </p>
              </div>
              <div className="mb-6">
                <h3 className="text-darkgray text-[17px] leading-[17px] mb-2 font-semibold">Sydney</h3>
                <p className="text-sm text-lightgray">944 Locust View Drive <br/>Novato, CA 94947 </p>
              </div>
              <div className="mb-6">
                <h3 className="text-darkgray text-[17px] leading-[17px] mb-2 font-semibold">London</h3>
                <p className="text-sm text-lightgray">2812 Southern Avenue <br/>Osceola, IA 50213 </p>
              </div>
            </div>
            <div>
              <div className="mb-6">
                <h3 className="text-darkgray text-[17px] leading-[17px] mb-2 font-semibold">New York</h3>
                <p className="text-sm text-lightgray">4299 Reppert Coal Road<br/> Detroit, MI 48219 </p>
              </div>
              <div className="mb-6">
                <h3 className="text-darkgray text-[17px] leading-[17px] mb-2 font-semibold">Dhaka</h3>
                <p className="text-sm text-lightgray">1678 Coal Road <br/> Brookside (Lycoming), PA 17963 </p>
              </div>
              <div className="mb-6">
                <h3 className="text-darkgray text-[17px] leading-[17px] mb-2 font-semibold">Stockholm</h3>
                <p className="text-sm text-lightgray">2630 Franklee Lane <br/> Philadelphia, PA 19108 </p>
              </div>
            </div>
          </div>
      </div>

                    ...
                    >
                      ...
                      <div className="mt-1">
                        {col.type === "text" && (
                          <input
                            type="text"
                            className="border border-gray-100 focus:outline-none rounded px-2 py-1 w-full text-sm"
                        ...
                        {col.type === "range" && (
                          <div className="flex gap-2">
                            <input
                              type="number"
                              className="border border-gray-100 focus:outline-none rounded px-2 py-1 w-20 text-sm"
